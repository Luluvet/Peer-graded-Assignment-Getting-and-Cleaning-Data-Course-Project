...
> colnames(y_train) <-"Id_atreino"
> colnames(y_train) <-"id_Atreino"
> View(subject_train)
> col.names(features) = c("n","functions")
Error in col.names(features) = c("n", "functions") : 
  object 'features' not found
> colnames(features) = c("n","functions")
Error in colnames(features) = c("n", "functions") : 
  object 'features' not found
> features <- read.table("UCI HAR Dataset/features.txt", col.names = c("n","functions"))
> View(features)
> features <- read.table("UCI HAR Dataset/features.txt", col.names = c("n","funcao"))
> atividade <- read.table("UCI HAR Dataset/activity_labels.txt", col.names = c("id_atividade", "atividade"))
> View(atividade)
> View(atividade)
> View(features)
> features <- read.table("UCI HAR Dataset/features.txt", col.names = c("id_features","funcao"))
> activity <- read.table("UCI HAR Dataset/activity_labels.txt", col.names = c("id_activity", "activity"))
> View(atividade)
> View(atividade)
> subject_test <- read.table("UCI HAR Dataset/test/subject_test.txt", col.names = "subject")
> x_test <- read.table("UCI HAR Dataset/test/X_test.txt", col.names = features$functions)
Error in read.table("UCI HAR Dataset/test/X_test.txt", col.names = features$functions) : 
  more columns than column names
> y_test <- read.table("UCI HAR Dataset/test/y_test.txt", col.names = "code")
> subject_train <- read.table("UCI HAR Dataset/train/subject_train.txt", col.names = "subject")
> x_train <- read.table("UCI HAR Dataset/train/X_train.txt", col.names = features$functions)
Error in read.table("UCI HAR Dataset/train/X_train.txt", col.names = features$functions) : 
  more columns than column names
...
# Groups:   subject [30]
 ...
 7       2 LAYING              0.281         -0.0182           -0.107            -0.510            0.753
 8       2 SITTING             0.277         -0.0157           -0.109             0.940           -0.106
 9       2 STANDING            0.278         -0.0184           -0.106             0.897           -0.370
10       2 WALKING             0.276         -0.0186           -0.106             0.913           -0.347
# … with 170 more rows, and 81 more variables: TimeGravityAccelerometer.mean...Z <dbl>,
...
#   TimeBodyGyroscope.mean...Y <dbl>, TimeBodyGyroscope.mean...Z <dbl>, TimeBodyGyroscopeJerk.mean...X <dbl>,
...
#   FrequencyBodyAccelerometer.meanFreq...X <dbl>, FrequencyBodyAccelerometer.meanFreq...Y <dbl>,
#   FrequencyBodyAccelerometer.meanFreq...Z <dbl>, FrequencyBodyAccelerometerJerk.mean...X <dbl>,
#   FrequencyBodyAccelerometerJerk.mean...Y <dbl>, FrequencyBodyAccelerometerJerk.mean...Z <dbl>,
#   FrequencyBodyAccelerometerJerk.meanFreq...X <dbl>, FrequencyBodyAccelerometerJerk.meanFreq...Y <dbl>,
...
#   FrequencyBodyAccelerometerJerkMagnitude.meanFreq.. <dbl>, FrequencyBodyGyroscopeMagnitude.mean.. <dbl>,
#   FrequencyBodyGyroscopeMagnitude.meanFreq.. <dbl>, FrequencyBodyGyroscopeJerkMagnitude.mean.. <dbl>,
#   FrequencyBodyGyroscopeJerkMagnitude.meanFreq.. <dbl>, Angle.TimeBodyAccelerometerMean.Gravity. <dbl>,
#   Angle.TimeBodyAccelerometerJerkMean..GravityMean. <dbl>, Angle.TimeBodyGyroscopeMean.GravityMean. <dbl>,
#   Angle.TimeBodyGyroscopeJerkMean.GravityMean. <dbl>, Angle.X.GravityMean. <dbl>, Angle.Y.GravityMean. <dbl>,
#   Angle.Z.GravityMean. <dbl>, TimeBodyAccelerometer.std...X <dbl>, TimeBodyAccelerometer.std...Y <dbl>,
#   TimeBodyAccelerometer.std...Z <dbl>, TimeGravityAccelerometer.std...X <dbl>,
#   TimeGravityAccelerometer.std...Y <dbl>, TimeGravityAccelerometer.std...Z <dbl>,
#   TimeBodyAccelerometerJerk.std...X <dbl>, TimeBodyAccelerometerJerk.std...Y <dbl>,
#   TimeBodyAccelerometerJerk.std...Z <dbl>, TimeBodyGyroscope.std...X <dbl>, TimeBodyGyroscope.std...Y <dbl>,
#   TimeBodyGyroscope.std...Z <dbl>, TimeBodyGyroscopeJerk.std...X <dbl>, TimeBodyGyroscopeJerk.std...Y <dbl>,
#   TimeBodyGyroscopeJerk.std...Z <dbl>, TimeBodyAccelerometerMagnitude.std.. <dbl>,
#   TimeGravityAccelerometerMagnitude.std.. <dbl>, TimeBodyAccelerometerJerkMagnitude.std.. <dbl>,
#   TimeBodyGyroscopeMagnitude.std.. <dbl>, TimeBodyGyroscopeJerkMagnitude.std.. <dbl>,
#   FrequencyBodyAccelerometer.std...X <dbl>, FrequencyBodyAccelerometer.std...Y <dbl>,
#   FrequencyBodyAccelerometer.std...Z <dbl>, FrequencyBodyAccelerometerJerk.std...X <dbl>,
#   FrequencyBodyAccelerometerJerk.std...Y <dbl>, FrequencyBodyAccelerometerJerk.std...Z <dbl>,
#   FrequencyBodyGyroscope.std...X <dbl>, FrequencyBodyGyroscope.std...Y <dbl>,
#   FrequencyBodyGyroscope.std...Z <dbl>, FrequencyBodyAccelerometerMagnitude.std.. <dbl>,
#   FrequencyBodyAccelerometerJerkMagnitude.std.. <dbl>, FrequencyBodyGyroscopeMagnitude.std.. <dbl>,
